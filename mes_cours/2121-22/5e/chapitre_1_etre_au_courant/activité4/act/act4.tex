...
\newcommand{\objectif}{ 	
	...
	\begin{itemize}
		...
		\item Être capable de passer d'un circuit au schéma électrique qu'il représente.
	\end{itemize}
} % titre de l'activité
\newcommand{\contexte}{ 
...
\begin{question}
	...
	\subquestion{Rajoute les fils électriques pour réaliser les
	circuits électriques.}
	\subquestion{À côté, schématise les circuits (attention, la boucle
	du circuit doit former un rectangle).}
	\subquestion{Avec le matériel, réalise les circuits.
