...
\newcommand{\titreActivite}{Act 4 : Dispositifs de protection} % titre de l'activité
\newcommand{\objectif}{ 	
...
\begin{question}
	...
	\questiontext{
		...
		\begin{enumerate}
			...
			\item Il devra contenir la réponse à la question suivante : 
			Pourquoi remplace t-on les fusibles par des disjoncteurs?
		\end{enumerate}
