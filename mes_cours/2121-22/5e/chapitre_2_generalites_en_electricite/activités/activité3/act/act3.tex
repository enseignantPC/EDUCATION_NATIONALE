...
\begin{minipage}[c]{0.45\textwidth}
	...
	\begin{question}
		\questiontext{
			...
			série comprenant une pile, deux lampes et un interrupteur fermé dans le rectangle à côté :
		}
	\end{question}
\end{minipage}
\hspace{ 20pt}
...
\begin{question}
	\questiontext{
		\textbf{Réaliser} ce nouveau circuit, qu'observes-tu ? \dotfill
	}
\end{question}
...
\end{question}
\subquestion{
	Que va peut-il se passer de potentiellement dangereux d'après toi?
}
\answerbox{2}
\subquestion{
...
\subquestion{
	Comment expliquer ce que l'on observe?
}
\answerbox{4}
