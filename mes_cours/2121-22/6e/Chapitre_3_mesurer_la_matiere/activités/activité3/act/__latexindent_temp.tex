...
\newcommand{\titreActivite}{Activité 3: Mesures expérimentales} % titre de l'activité
\newcommand{\objectif}{ 	
...
\end{center}
	...
	\begin{center}
		\begin{tabular}{ |c|c|c|c|c|c|c|  }
			...
			\makebox(0,20){} \hspace{10pt} Kilogramme \hspace{10pt} &\hspace{10pt}  Hectogramme \hspace{10pt} &\hspace{10pt}  Décagramme \hspace{10pt} &\hspace{10pt}  gramme \hspace{10pt} & \hspace{10pt} Décigramme\hspace{10pt}  & \hspace{10pt} Centigramme \hspace{10pt} & \hspace{10pt} Milligramme\hspace{10pt}  \\\hline% \makebox(0,15){}
			\makebox(0,15){} &  &  &  &  &  &  \\\hline% 
			\makebox(0,15){} &  &  &  &  &  &  \\\hline% 
			\makebox(0,15){} &  &  &  &  &  &  \\\hline% 
			\makebox(0,15){} &  &  &  &  &  &  \\\hline% 
